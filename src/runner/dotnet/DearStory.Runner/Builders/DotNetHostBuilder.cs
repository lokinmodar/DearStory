...
/// <summary>
/// Executes build requests for managed .NET DearStory hosts.
/// </summary>
public sealed class DotNetHostBuilder : IHostBuilder
{
    private readonly Func<HostBuildRequest, CancellationToken, Task<HostBuildResult>> _buildAsync;

    /// <summary>
    /// Initializes a new instance of the <see cref="DotNetHostBuilder" /> class.
    /// </summary>
    /// <param name="buildAsync">The optional build delegate used to execute the request.</param>
    public DotNetHostBuilder(Func<HostBuildRequest, CancellationToken, Task<HostBuildResult>>? buildAsync = null)
    {
